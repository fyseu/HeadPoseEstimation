...
#     n_classes += 1 # Account for the background class.
    ...
    # ****************************************************************************
    # 用于生成角度
    conv4_3_norm_mbox_angle = Conv2D(n_boxes[0] * 3, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv4_3_norm_mbox_angle')(conv4_3_norm)
    fc7_mbox_angle = Conv2D(n_boxes[1] * 3, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='fc7_mbox_angle')(fc7)
    conv6_2_mbox_angle = Conv2D(n_boxes[2] * 3, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv6_2_mbox_angle')(conv6_2)
    conv7_2_mbox_angle = Conv2D(n_boxes[3] * 3, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv7_2_mbox_angle')(conv7_2)
    conv8_2_mbox_angle = Conv2D(n_boxes[4] * 3, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv8_2_mbox_angle')(conv8_2)
    conv9_2_mbox_angle = Conv2D(n_boxes[5] * 3, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv9_2_mbox_angle')(conv9_2)
    conv10_2_mbox_angle = Conv2D(n_boxes[6] * 3, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv10_2_mbox_angle')(conv10_2)
    # ****************************************************************************
    ...
    # ****************************************************************************
    # reshape角度
    conv4_3_norm_mbox_angle_reshape = Reshape((-1, 3), name='conv4_3_norm_mbox_angle_reshape')(conv4_3_norm_mbox_angle)
    fc7_mbox_angle_reshape = Reshape((-1, 3), name='fc7_mbox_angle_reshape')(fc7_mbox_angle)
    conv6_2_mbox_angle_reshape = Reshape((-1, 3), name='conv6_2_mbox_angle_reshape')(conv6_2_mbox_angle)
    conv7_2_mbox_angle_reshape = Reshape((-1, 3), name='conv7_2_mbox_angle_reshape')(conv7_2_mbox_angle)
    conv8_2_mbox_angle_reshape = Reshape((-1, 3), name='conv8_2_mbox_angle_reshape')(conv8_2_mbox_angle)
    conv9_2_mbox_angle_reshape = Reshape((-1, 3), name='conv9_2_mbox_angle_reshape')(conv9_2_mbox_angle)
    conv10_2_mbox_angle_reshape = Reshape((-1, 3), name='conv10_2_mbox_angle_reshape')(conv10_2_mbox_angle)
    # ****************************************************************************
    ...
    # ****************************************************************************
    mbox_angle = Concatenate(axis=1, name='mbox_angle')([conv4_3_norm_mbox_angle_reshape,
                                                         fc7_mbox_angle_reshape,
                                                         conv6_2_mbox_angle_reshape,
                                                         conv7_2_mbox_angle_reshape,
                                                         conv8_2_mbox_angle_reshape,
                                                         conv9_2_mbox_angle_reshape,
                                                         conv10_2_mbox_angle_reshape])
    # ****************************************************************************
    ...
    #############################################################################
    predictions = Concatenate(axis=2, name='predictions')([mbox_conf_softmax, mbox_angle, mbox_loc, mbox_priorbox])
    #############################################################################
