...
def ssd_300(image_size,
    ...
    # ****************************************************************************
    # 用于生成角度
    conv4_3_norm_mbox_angle = Conv2D(n_boxes_conv4_3 * 2, (3, 3), padding='same', name='conv4_3_norm_mbox_angle')(conv4_3_norm)
    fc7_mbox_angle = Conv2D(n_boxes_fc7 * 2, (3, 3), padding='same', name='fc7_mbox_angle')(fc7)
    conv6_2_mbox_angle = Conv2D(n_boxes_conv6_2 * 2, (3, 3), padding='same', name='conv6_2_mbox_angle')(conv6_2)
    conv7_2_mbox_angle = Conv2D(n_boxes_conv7_2 * 2, (3, 3), padding='same', name='conv7_2_mbox_angle')(conv7_2)
    conv8_2_mbox_angle = Conv2D(n_boxes_conv8_2 * 2, (3, 3), padding='same', name='conv8_2_mbox_angle')(conv8_2)
    conv9_2_mbox_angle = Conv2D(n_boxes_conv9_2 * 2, (3, 3), padding='same', name='conv9_2_mbox_angle')(conv9_2)
    # ****************************************************************************
    ...
    # ****************************************************************************
    # reshape角度
    conv4_3_norm_mbox_angle_reshape = Reshape((-1, 2), name='conv4_3_norm_mbox_angle_reshape')(conv4_3_norm_mbox_angle)
    fc7_mbox_angle_reshape = Reshape((-1, 2), name='fc7_mbox_angle_reshape')(fc7_mbox_angle)
    conv6_2_mbox_angle_reshape = Reshape((-1, 2), name='conv6_2_mbox_angle_reshape')(conv6_2_mbox_angle)
    conv7_2_mbox_angle_reshape = Reshape((-1, 2), name='conv7_2_mbox_angle_reshape')(conv7_2_mbox_angle)
    conv8_2_mbox_angle_reshape = Reshape((-1, 2), name='conv8_2_mbox_angle_reshape')(conv8_2_mbox_angle)
    conv9_2_mbox_angle_reshape = Reshape((-1, 2), name='conv9_2_mbox_angle_reshape')(conv9_2_mbox_angle)
    # ****************************************************************************
