...
def build_model(image_size,
    ...
    #用于生成角度
    classes4_2 = Conv2D(n_boxes_conv4 * 2, (3, 3), strides=(1, 1), padding="valid", name='classes4_2')(conv4)
    classes5_2 = Conv2D(n_boxes_conv5 * 2, (3, 3), strides=(1, 1), padding="valid", name='classes5_2')(conv5)
    classes6_2 = Conv2D(n_boxes_conv6 * 2, (3, 3), strides=(1, 1), padding="valid", name='classes6_2')(conv6)
    classes7_2 = Conv2D(n_boxes_conv7 * 2, (3, 3), strides=(1, 1), padding="valid", name='classes7_2')(conv7)
    ...
    #reshape角度
    classes4_2_reshaped = Reshape((-1, 2), name='classes4_2_reshape')(classes4_2)
    classes5_2_reshaped = Reshape((-1, 2), name='classes5_2_reshape')(classes5_2)
    classes6_2_reshaped = Reshape((-1, 2), name='classes6_2_reshape')(classes6_2)
    classes7_2_reshaped = Reshape((-1, 2), name='classes7_2_reshape')(classes7_2)
    ...
    classes_2_concat = Concatenate(axis=1, name='classes_2_concat')([classes4_2_reshaped,
                                                                 classes5_2_reshaped,
                                                                 classes6_2_reshaped,
                                                                 classes7_2_reshaped])
    ...
    predictions = Concatenate(axis=2, name='predictions')([classes_softmax, classes_2_concat, boxes_concat, anchors_concat])
